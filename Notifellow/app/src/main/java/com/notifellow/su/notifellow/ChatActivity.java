...
public class ChatActivity extends AppCompatActivity {
    private final String mChannelUrl = "sendbird_open_channel_37179_530943243a739e5eac8aa797a2f0dff3be57b06e";
    ...
    private class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private class SentMessageHolder extends RecyclerView.ViewHolder {
            ...
            void bind(UserMessage message) {
                ...
                timeText.setText(ChatUtils.formatTime(message.getCreatedAt()));
            }
        }
        ...
        private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
            ...
            void bind(UserMessage message) {
                ...
                ChatUtils.displayRoundImageFromUrl(ChatActivity.this,
